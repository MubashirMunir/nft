...
import 'package:Species/page/firstScreen.dart';
import 'package:carousel_slider/carousel_controller.dart';
import 'package:carousel_slider/carousel_slider.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

import '../other pages/botomnav.dart';
class details extends StatefulWidget {
 ...
 class _detailsState extends State<details>{
  ...
  final Item item;
int currentIndex=0;
static const menuItem=<String>['One'
'Two''Three''Four'
];
        ...
        child: Column(
          children: [
            ...
            child:Padding(
              ...
              child: Text(item.name,style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold),textAlign: TextAlign.center,softWrap: true,),)),
           SizedBox(height: 10),
            Container(
              decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(30),
                ...
                child: Padding(
                  ...
                  child: Text(item.desc,style: TextStyle(fontSize: 15),),
                ),
            )
          ]),
      )
