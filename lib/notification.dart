    ...
    return Center(
      child: Scaffold(
        body: Column(mainAxisAlignment: MainAxisAlignment.center,
          children:[
          Center(child: ClipRRect(borderRadius: BorderRadius.circular(25),
            child: Container(width: 150,height: 30,
...
showAlertDialog(BuildContext context){
  Widget okbutton =RaisedButton(onPressed: Navigator.of(context).pop);
